...
def create_report_log_module(local_config):
    df, error_flag, error_msg = tm.read_table_csv(local_config, 'meta_data','log','module_run')
    if error_flag:
        print('Error creating Module log html report')
        return
